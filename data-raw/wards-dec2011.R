...
# Collect data
api_url <- extract_api_url("wards_dec2011")

wards_dec2011_no_lad <- sf::read_sf(api_url) |>
...
wards_dec2011_with_lad <- dplyr::left_join(
  wards_dec2011_no_lad, lookup, by = dplyr::join_by(WD11CD)
)
...
wards_dec2011 <-
  rmapshaper::ms_simplify(wards_dec2011_with_lad, keep = 0.2)

# Write to data folder
usethis::use_data(wards_dec2011, overwrite = TRUE)
