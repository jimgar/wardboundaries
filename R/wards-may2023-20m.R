...
#'
#' Boundaries for Wards in the United Kingdom as at May 2023. (BGC) Generalised (20m) - clipped to the coastline (Mean High Water mark). Contains both Ordnance Survey and ONS Intellectual Property Rights. 
#'
...
#' }
#' @source \url{https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/WD_MAY_2023_UK_BGC/FeatureServer/0/query?outFields=*&where=1%3D1&f=geojson}
"wards_may2023_20m"